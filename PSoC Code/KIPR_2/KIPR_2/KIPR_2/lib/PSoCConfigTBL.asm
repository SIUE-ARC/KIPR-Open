...
;  Instance name ENC1A_FEDGE, User Module DigInv
;       Instance name ENC1A_FEDGE, Block Name DigInv(DBB10)
	db		33h, 00h		;ENC1A_FEDGE_CONTROL_REG(DBB10CR0)
	db		31h, 00h		;ENC1A_FEDGE_PERIOD_REG (DBB10DR1)
	db		32h, 00h		;ENC1A_FEDGE_COMPARE_REG(DBB10DR2)
...
;  Instance name ENC1B_FEDGE, User Module DigInv
;       Instance name ENC1B_FEDGE, Block Name DigInv(DBB21)
	db		47h, 00h		;ENC1B_FEDGE_CONTROL_REG(DBB21CR0)
	db		45h, 00h		;ENC1B_FEDGE_PERIOD_REG (DBB21DR1)
	db		46h, 00h		;ENC1B_FEDGE_COMPARE_REG(DBB21DR2)
...
;  Instance name ENC1A_FEDGE, User Module DigInv
;       Instance name ENC1A_FEDGE, Block Name DigInv(DBB10)
	db		30h, 20h		;ENC1A_FEDGE_FUNC_REG   (DBB10FN)
	db		31h, 0eh		;ENC1A_FEDGE_INPUT_REG  (DBB10IN)
	db		32h, 40h		;ENC1A_FEDGE_OUTPUT_REG (DBB10OU)
;  Instance name ENC1A_PEDGE, User Module DigBuf
;       Instance name ENC1A_PEDGE, Block Name DigBuf(DBB00)
...
;  Instance name ENC1B_FEDGE, User Module DigInv
;       Instance name ENC1B_FEDGE, Block Name DigInv(DBB21)
	db		44h, 20h		;ENC1B_FEDGE_FUNC_REG   (DBB21FN)
	db		45h, 0ch		;ENC1B_FEDGE_INPUT_REG  (DBB21IN)
	db		46h, 40h		;ENC1B_FEDGE_OUTPUT_REG (DBB21OU)
;  Instance name ENC1B_PEDGE, User Module DigBuf
;       Instance name ENC1B_PEDGE, Block Name DigBuf(DBB11)
