...
;  Global Symbols
;-----------------------------------------------
export   ENC1B_NEDGE_EnableInt
export  _ENC1B_NEDGE_EnableInt
export   ENC1B_NEDGE_DisableInt
export  _ENC1B_NEDGE_DisableInt
export   ENC1B_NEDGE_Start
export  _ENC1B_NEDGE_Start
export   ENC1B_NEDGE_Stop
export  _ENC1B_NEDGE_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_NEDGE_EnableInt
;
;  DESCRIPTION:
...
_ENC1B_NEDGE_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask ENC1B_NEDGE_INT_REG, ENC1B_NEDGE_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_NEDGE_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 ENC1B_NEDGE_DisableInt:
_ENC1B_NEDGE_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask ENC1B_NEDGE_INT_REG, ENC1B_NEDGE_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_NEDGE_Start
;
;  DESCRIPTION:
...
_ENC1B_NEDGE_Start:
   ...
   mov   A, REG[ENC1B_NEDGE_OUTPUT_REG]
   push  A

   mov   REG[ENC1B_NEDGE_OUTPUT_REG], 0

   ; set the input to the 48MHz clock
   mov   A, REG[ENC1B_NEDGE_INPUT_REG]
   push  A

   mov   REG[ENC1B_NEDGE_INPUT_REG], 04

   M8C_SetBank0
   ; start the inverter
   or    REG[ENC1B_NEDGE_CONTROL_REG], bfCONTROL_REG_START_BIT

   ; Re-instate the input
   M8C_SetBank1
   pop   A
   mov   REG[ENC1B_NEDGE_INPUT_REG], A

   ; Re-instate the output
   pop   A
   mov   REG[ENC1B_NEDGE_OUTPUT_REG], A
   M8C_SetBank0

   ;clear interrupt
   M8C_ClearIntFlag INT_CLR1, ENC1B_NEDGE_bINT_MASK

   ; Re-instate the interrupt state
   pop   A
   mov   REG[ENC1B_NEDGE_INT_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_NEDGE_Stop
;
;  DESCRIPTION:
...
_ENC1B_NEDGE_Stop:
   ...
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[ENC1B_NEDGE_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File ENC1B_NEDGE.asm
