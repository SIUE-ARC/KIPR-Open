...
;  Instance name VelTimer, User Module Timer32
;       Instance name VelTimer, Block Name TIMER32_ISB1(DBB31)
	db		57h, 00h		;VelTimer_CONTROL_ISB1_REG(DBB31CR0)
	db		55h, ffh		;VelTimer_PERIOD_ISB1_REG(DBB31DR1)
	db		56h, 00h		;VelTimer_COMPARE_ISB1_REG(DBB31DR2)
;       Instance name VelTimer, Block Name TIMER32_ISB2(DCB32)
	db		5bh, 00h		;VelTimer_CONTROL_ISB2_REG(DCB32CR0)
	db		59h, ffh		;VelTimer_PERIOD_ISB2_REG(DCB32DR1)
	db		5ah, 00h		;VelTimer_COMPARE_ISB2_REG(DCB32DR2)
;       Instance name VelTimer, Block Name TIMER32_LSB(DBB30)
	db		53h, 00h		;VelTimer_CONTROL_LSB_REG(DBB30CR0)
	db		51h, ffh		;VelTimer_PERIOD_LSB_REG(DBB30DR1)
	db		52h, 00h		;VelTimer_COMPARE_LSB_REG(DBB30DR2)
;       Instance name VelTimer, Block Name TIMER32_MSB(DCB33)
	db		5fh, 06h		;VelTimer_CONTROL_MSB_REG(DCB33CR0)
	db		5dh, 7fh		;VelTimer_PERIOD_MSB_REG(DCB33DR1)
...
;  Instance name VelTimer, User Module Timer32
;       Instance name VelTimer, Block Name TIMER32_ISB1(DBB31)
	db		54h, 00h		;VelTimer_FUNC_ISB1_REG(DBB31FN)
	db		55h, 34h		;VelTimer_INPUT_ISB1_REG(DBB31IN)
	db		56h, 80h		;VelTimer_OUTPUT_ISB1_REG(DBB31OU)
;       Instance name VelTimer, Block Name TIMER32_ISB2(DCB32)
	db		58h, 00h		;VelTimer_FUNC_ISB2_REG(DCB32FN)
	db		59h, 34h		;VelTimer_INPUT_ISB2_REG(DCB32IN)
	db		5ah, 80h		;VelTimer_OUTPUT_ISB2_REG(DCB32OU)
;       Instance name VelTimer, Block Name TIMER32_LSB(DBB30)
	db		50h, 00h		;VelTimer_FUNC_LSB_REG(DBB30FN)
	db		51h, 14h		;VelTimer_INPUT_LSB_REG(DBB30IN)
	db		52h, 80h		;VelTimer_OUTPUT_LSB_REG(DBB30OU)
;       Instance name VelTimer, Block Name TIMER32_MSB(DCB33)
