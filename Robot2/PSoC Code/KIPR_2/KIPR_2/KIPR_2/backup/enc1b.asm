...
;  Global Symbols
;-----------------------------------------------
export  ENC1B_EnableInt
export _ENC1B_EnableInt
export  ENC1B_DisableInt
export _ENC1B_DisableInt
export  ENC1B_Start
export _ENC1B_Start
export  ENC1B_Stop
export _ENC1B_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_DisableInt
;
;  DESCRIPTION:
