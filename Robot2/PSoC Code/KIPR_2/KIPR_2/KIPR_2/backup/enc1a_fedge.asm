...
;  Global Symbols
;-----------------------------------------------
export   ENC1A_FEDGE_EnableInt
export  _ENC1A_FEDGE_EnableInt
export   ENC1A_FEDGE_DisableInt
export  _ENC1A_FEDGE_DisableInt
export   ENC1A_FEDGE_Start
export  _ENC1A_FEDGE_Start
export   ENC1A_FEDGE_Stop
export  _ENC1A_FEDGE_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1A_FEDGE_EnableInt
;
;  DESCRIPTION:
...
_ENC1A_FEDGE_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask ENC1A_FEDGE_INT_REG, ENC1A_FEDGE_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1A_FEDGE_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 ENC1A_FEDGE_DisableInt:
_ENC1A_FEDGE_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask ENC1A_FEDGE_INT_REG, ENC1A_FEDGE_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1A_FEDGE_Start
;
;  DESCRIPTION:
...
_ENC1A_FEDGE_Start:
   ...
   mov   A, REG[ENC1A_FEDGE_OUTPUT_REG]
   push  A

   mov   REG[ENC1A_FEDGE_OUTPUT_REG], 0

   ; set the input to the 48MHz clock
   mov   A, REG[ENC1A_FEDGE_INPUT_REG]
   push  A

   mov   REG[ENC1A_FEDGE_INPUT_REG], 04

   M8C_SetBank0
   ; start the inverter
   or    REG[ENC1A_FEDGE_CONTROL_REG], bfCONTROL_REG_START_BIT

   ; Re-instate the input
   M8C_SetBank1
   pop   A
   mov   REG[ENC1A_FEDGE_INPUT_REG], A

   ; Re-instate the output
   pop   A
   mov   REG[ENC1A_FEDGE_OUTPUT_REG], A
   M8C_SetBank0

   ;clear interrupt
   M8C_ClearIntFlag INT_CLR1, ENC1A_FEDGE_bINT_MASK

   ; Re-instate the interrupt state
   pop   A
   mov   REG[ENC1A_FEDGE_INT_REG], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1A_FEDGE_Stop
;
;  DESCRIPTION:
...
_ENC1A_FEDGE_Stop:
   ...
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[ENC1A_FEDGE_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File ENC1A_FEDGE.asm
