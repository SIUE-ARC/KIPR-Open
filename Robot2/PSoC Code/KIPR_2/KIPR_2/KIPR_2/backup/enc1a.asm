...
;  Global Symbols
;-----------------------------------------------
export  ENC1A_EnableInt
export _ENC1A_EnableInt
export  ENC1A_DisableInt
export _ENC1A_DisableInt
export  ENC1A_Start
export _ENC1A_Start
export  ENC1A_Stop
export _ENC1A_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1A_DisableInt
;
;  DESCRIPTION:
