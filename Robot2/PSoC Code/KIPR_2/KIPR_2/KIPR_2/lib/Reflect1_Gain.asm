;;*****************************************************************************
;;*****************************************************************************
;;  FILENAME:   Reflect1_Gain.asm  ( PGA )
...
;  Global Symbols
;-----------------------------------------------
export  Reflect1_Gain_Start
export _Reflect1_Gain_Start
export  Reflect1_Gain_SetPower
export _Reflect1_Gain_SetPower

export  Reflect1_Gain_SetGain
export _Reflect1_Gain_SetGain

export  Reflect1_Gain_Stop
export _Reflect1_Gain_Stop

IF (Reflect1_Gain_AGNDBUFAPI)
export  Reflect1_Gain_EnableAGNDBuffer
export _Reflect1_Gain_EnableAGNDBuffer
export  Reflect1_Gain_DisableAGNDBuffer
export _Reflect1_Gain_DisableAGNDBuffer
ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Reflect1_Gain_Start
;  FUNCTION NAME: Reflect1_Gain_SetPower
;
;  DESCRIPTION:
...
;
 Reflect1_Gain_Start:
_Reflect1_Gain_Start:
 Reflect1_Gain_SetPower:
_Reflect1_Gain_SetPower:
...
;
   ...
   mov  A, reg[Reflect1_Gain_GAIN_CR2]                     ; read power value
   and  A, ~POWERMASK                                ; clear power bits in A
   or   A, [X]                                       ; combine power value with balance of reg.
   mov  reg[Reflect1_Gain_GAIN_CR2], A                ; move complete value back to register
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Reflect1_Gain_SetGain
;
;  DESCRIPTION:
...
;    functions.
;
 Reflect1_Gain_SetGain:
_Reflect1_Gain_SetGain:
...
;
   ...
   mov  A, reg[Reflect1_Gain_GAIN_CR0]                     ; read mux settings
   and  A, ~GAINREGMASK                                   ; clear gain bits in A
   tst  [X],HIGHGAIN                                      ; See if High Gain is set
   jnz  .SETHIGHGAIN
   and  reg[Reflect1_Gain_GAIN_CR3],~EXGAIN                ; Clear High Gain bit.
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[Reflect1_Gain_GAIN_CR0], A                     ; move complete value back to register
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SETHIGHGAIN:
   ...
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[Reflect1_Gain_GAIN_CR0], A                     ; move complete value back to register
   or   reg[Reflect1_Gain_GAIN_CR3], EXGAIN                ; Set High Gain bit.
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Reflect1_Gain_Stop
;
;  DESCRIPTION:
...
_Reflect1_Gain_Stop:
   ...
   and REG[Reflect1_Gain_GAIN_CR2], ~POWERMASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Reflect1_Gain_EnableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 Reflect1_Gain_EnableAGNDBuffer:
_Reflect1_Gain_EnableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   reg[Reflect1_Gain_GAIN_CR3], ~AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Reflect1_Gain_DisableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 Reflect1_Gain_DisableAGNDBuffer:
_Reflect1_Gain_DisableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or    reg[Reflect1_Gain_GAIN_CR3], AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
ENDIF

; End of File Reflect1_Gain.asm
