...
;  Instance name DelSig_1, User Module DelSig
;       Instance name DelSig_1, Block Name ADC1(ASC10)
	db		80h, 88h		;DelSig_1_AtoD1cr0(ASC10CR0)
	db		81h, 00h		;DelSig_1_AtoD1cr1(ASC10CR1)
	db		82h, 00h		;DelSig_1_AtoD1cr2(ASC10CR2)
	db		83h, ech		;DelSig_1_AtoD1cr3(ASC10CR3)
;       Instance name DelSig_1, Block Name ADC2(ASD20)
	db		90h, 90h		;DelSig_1_AtoD2cr0(ASD20CR0)
	db		91h, 00h		;DelSig_1_AtoD2cr1(ASD20CR1)
	db		92h, 40h		;DelSig_1_AtoD2cr2(ASD20CR2)
	db		93h, e0h		;DelSig_1_AtoD2cr3(ASD20CR3)
;       Instance name DelSig_1, Block Name PWM(DBB30)
	db		53h, 00h		;DelSig_1_PWM_CR0(DBB30CR0)
	db		51h, ffh		;DelSig_1_PWM_DR1(DBB30DR1)
	db		52h, 01h		;DelSig_1_PWM_DR2(DBB30DR2)
...
;       Instance name VelTimer, Block Name TIMER24_ISB(DCB32)
	...
	db		59h, 00h		;VelTimer_PERIOD_ISB_REG(DCB32DR1)
...
;       Instance name VelTimer, Block Name TIMER24_LSB(DBB31)
	...
	db		55h, 00h		;VelTimer_PERIOD_LSB_REG(DBB31DR1)
	db		56h, 00h		;VelTimer_COMPARE_LSB_REG(DBB31DR2)
;       Instance name VelTimer, Block Name TIMER24_MSB(DCB33)
	db		5fh, 04h		;VelTimer_CONTROL_MSB_REG(DCB33CR0)
	db		5dh, 00h		;VelTimer_PERIOD_MSB_REG(DCB33DR1)
...
;       Instance name DelSig_1, Block Name ADC2(ASD20)
;       Instance name DelSig_1, Block Name PWM(DBB30)
	db		50h, 31h		;DelSig_1_PWM_FN(DBB30FN)
	db		51h, 15h		;DelSig_1_PWM_SL(DBB30IN)
	db		52h, 40h		;DelSig_1_PWM_OS(DBB30OU)
;  Instance name ENC1A_NEDGE, User Module DigInv
;       Instance name ENC1A_NEDGE, Block Name DigInv(DBB10)
...
;       Instance name VelTimer, Block Name TIMER24_ISB(DCB32)
	...
	db		59h, 30h		;VelTimer_INPUT_ISB_REG(DCB32IN)
	db		5ah, 00h		;VelTimer_OUTPUT_ISB_REG(DCB32OU)
;       Instance name VelTimer, Block Name TIMER24_LSB(DBB31)
	db		54h, 00h		;VelTimer_FUNC_LSB_REG(DBB31FN)
	db		55h, 00h		;VelTimer_INPUT_LSB_REG(DBB31IN)
	db		56h, 00h		;VelTimer_OUTPUT_LSB_REG(DBB31OU)
;       Instance name VelTimer, Block Name TIMER24_MSB(DCB33)
	db		5ch, 20h		;VelTimer_FUNC_MSB_REG(DCB33FN)
	db		5dh, 30h		;VelTimer_INPUT_MSB_REG(DCB33IN)
	db		5eh, 00h		;VelTimer_OUTPUT_MSB_REG(DCB33OU)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[00h], 88h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 77h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 77h		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], 88h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
