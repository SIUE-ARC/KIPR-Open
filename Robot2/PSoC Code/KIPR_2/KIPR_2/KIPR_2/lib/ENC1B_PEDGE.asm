...
include "m8c.inc"
include "memory.inc"
include "ENC1B_PEDGE.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  ENC1B_PEDGE_EnableInt
export _ENC1B_PEDGE_EnableInt
export  ENC1B_PEDGE_DisableInt
export _ENC1B_PEDGE_DisableInt
export  ENC1B_PEDGE_Start
export _ENC1B_PEDGE_Start
export  ENC1B_PEDGE_Stop
export _ENC1B_PEDGE_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_PEDGE_EnableInt
;
;  DESCRIPTION:
...
_ENC1B_PEDGE_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1   
   ENC1B_PEDGE_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_PEDGE_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 ENC1B_PEDGE_DisableInt:
_ENC1B_PEDGE_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1   
   ENC1B_PEDGE_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_PEDGE_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ENC1B_PEDGE_Stop
;
;  DESCRIPTION:
