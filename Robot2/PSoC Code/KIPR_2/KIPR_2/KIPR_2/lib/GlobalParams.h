...
#define PORT_0_GLOBAL_SELECT   0xce    //Port 0 global select register (PRT0GS)
...
#define PORT_0_DRIVE_2         0x21    //Port 0 drive mode 1 register (PRT0DM2)
...
#define PORT_1_GLOBAL_SELECT   0x20    //Port 1 global select register (PRT1GS)
