...
;  Global Symbols
;-----------------------------------------------
export  LightSensor_Start
export _LightSensor_Start
export  LightSensor_SetPower
export _LightSensor_SetPower

export  LightSensor_SetGain
export _LightSensor_SetGain

export  LightSensor_Stop
export _LightSensor_Stop

IF (LightSensor_AGNDBUFAPI)
export  LightSensor_EnableAGNDBuffer
export _LightSensor_EnableAGNDBuffer
export  LightSensor_DisableAGNDBuffer
export _LightSensor_DisableAGNDBuffer
ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LightSensor_Start
;  FUNCTION NAME: LightSensor_SetPower
;
;  DESCRIPTION:
...
;
 LightSensor_Start:
_LightSensor_Start:
 LightSensor_SetPower:
_LightSensor_SetPower:
...
;
   ...
   mov  A, reg[LightSensor_GAIN_CR2]                       ; read power value
   and  A, ~POWERMASK                                ; clear power bits in A
   or   A, [X]                                       ; combine power value with balance of reg.
   mov  reg[LightSensor_GAIN_CR2], A                  ; move complete value back to register
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LightSensor_SetGain
;
;  DESCRIPTION:
...
;
   ...
   mov  A, reg[LightSensor_GAIN_CR0]                       ; read mux settings
   and  A, ~GAINREGMASK                                   ; clear gain bits in A
   tst  [X],HIGHGAIN                                      ; See if High Gain is set
   jnz  .SETHIGHGAIN
   and  reg[LightSensor_GAIN_CR3],~EXGAIN                  ; Clear High Gain bit.
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[LightSensor_GAIN_CR0], A                       ; move complete value back to register
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SETHIGHGAIN:
   ...
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[LightSensor_GAIN_CR0], A                       ; move complete value back to register
   or   reg[LightSensor_GAIN_CR3], EXGAIN                  ; Set High Gain bit.
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LightSensor_Stop
;
;  DESCRIPTION:
...
_LightSensor_Stop:
   ...
   and REG[LightSensor_GAIN_CR2], ~POWERMASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LightSensor_EnableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 LightSensor_EnableAGNDBuffer:
_LightSensor_EnableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   reg[LightSensor_GAIN_CR3], ~AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LightSensor_DisableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 LightSensor_DisableAGNDBuffer:
_LightSensor_DisableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or    reg[LightSensor_GAIN_CR3], AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
ENDIF

; End of File LightSensor.asm
