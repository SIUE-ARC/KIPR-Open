...
;  Global Symbols
;-----------------------------------------------
export  LDR_ADC_Start
export _LDR_ADC_Start
export  LDR_ADC_SetPower
export _LDR_ADC_SetPower
export  LDR_ADC_cGetSample
export _LDR_ADC_cGetSample
export  LDR_ADC_Stop
export _LDR_ADC_Stop
...
; a future release.
;-----------------------------------------------
export  LDR_ADC_GetSample
export _LDR_ADC_GetSample
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LDR_ADC_Start
;  FUNCTION NAME: LDR_ADC_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LDR_ADC_cGetSample
;
;  DESCRIPTION:
...
PSOC_SAR_SIGN:         equ 20h ;
 ...
 LDR_ADC_cGetSample:
_LDR_ADC_cGetSample:
 LDR_ADC_GetSample:  ; WARNING, this label will be removed in a future release.
_LDR_ADC_GetSample:  ; WARNING, this label will be removed in a future release.
    ...
    mov  reg[LDR_ADC_CR0], LDR_ADC_CR0_INIT
    mov  reg[ASY_CR], PSOC_SAR_CTRL | LDR_ADC_SCCOL_MASK
    ...
    or   reg[LDR_ADC_CR0], 0   ; set sign & try MSB of magnitude
    or   reg[LDR_ADC_CR0], 0   ; set MSB of magnitude and try next lower
    or   reg[LDR_ADC_CR0], 0   ;                      ... and next ...
    or   reg[LDR_ADC_CR0], 0   ;                      ... and next ...
    or   reg[LDR_ADC_CR0], 0   ;                      ... and try LSB
    or   reg[LDR_ADC_CR0], 0   ; and, finally, set LSB of magnitude.
    ...
    ;; for negative values.
    mov  A, reg[LDR_ADC_CR0]
    and  A, PSOC_SAR_MAGNITUDE
    tst  reg[LDR_ADC_CR0], PSOC_SAR_SIGN
...
_LDR_ADC_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1
    and reg[LDR_ADC_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION

; End of File LDR_ADC.asm
