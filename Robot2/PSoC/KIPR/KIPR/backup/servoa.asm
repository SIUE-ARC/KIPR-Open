...
;  Global Symbols
;-----------------------------------------------
export  ServoA_EnableInt
export _ServoA_EnableInt
export  ServoA_DisableInt
export _ServoA_DisableInt
export  ServoA_Start
export _ServoA_Start
export  ServoA_Stop
export _ServoA_Stop
export  ServoA_WritePeriod
export _ServoA_WritePeriod
export  ServoA_WritePulseWidth
export _ServoA_WritePulseWidth
export  ServoA_wReadPulseWidth
export _ServoA_wReadPulseWidth
export  ServoA_wReadCounter
export _ServoA_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wServoA_ReadPulseWidth    ; deprecated
export _wServoA_ReadPulseWidth    ; deprecated
export  wServoA_ReadCounter       ; deprecated
export _wServoA_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ServoA_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ServoA_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ServoA_WritePeriod
;
;  DESCRIPTION:
...
_ServoA_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[ServoA_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[ServoA_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ServoA_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 ServoA_WritePulseWidth:
_ServoA_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[ServoA_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[ServoA_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ServoA_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 ServoA_wReadPulseWidth:
_ServoA_wReadPulseWidth:
 wServoA_ReadPulseWidth:                         ; this name deprecated
_wServoA_ReadPulseWidth:                         ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[ServoA_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[ServoA_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ServoA_wReadCounter
;
;  DESCRIPTION:
...
;
 ServoA_wReadCounter:
_ServoA_wReadCounter:
 wServoA_ReadCounter:                            ; this name deprecated
_wServoA_ReadCounter:                            ; this name deprecated
   ...
   mov   A, reg[ServoA_COMPARE_MSB_REG]          ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[ServoA_COMPARE_LSB_REG]          ;
   push  A                                          ;  -stack frame now 2 bytes-
   ServoA_Stop_M                                 ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[ServoA_INPUT_LSB_REG]            ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[ServoA_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[ServoA_COUNTER_MSB_REG]          ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[ServoA_COMPARE_MSB_REG]          ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[ServoA_COUNTER_LSB_REG]          ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[ServoA_COMPARE_LSB_REG]          ; Stash the Count LSB on the stack
   ...
   mov   reg[ServoA_INPUT_LSB_REG], A            ;    and restore it
   M8C_SetBank0                                     ;
   ServoA_Start_M                                ; Now re-enable the PWM function
